      ...
      >
        ...
        <div className="space-y-4">
          <input
            ...
            required
            minLength={3}
            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-sm md:text-base"
          />
          <input
            type="email"
            name="email"
        ...
        <button
          type="submit"
          className="w-full bg-purple-500 text-white py-2 rounded-lg hover:bg-purple-600 transition text-sm md:text-base"
        >
          Sign Up
        </button>
      </form>
