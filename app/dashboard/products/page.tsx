...
const allProducts: Product[] = [
  { id: 1, name: 'Dell Inspiron Laptop', image: '/laptop.png', price: 52999, originalPrice: 59999 },
  { id: 2, name: 'Samsung Galaxy M14', image: '/mobile.png', price: 13499, originalPrice: 14999 },
  { id: 3, name: 'Sony Wireless Headphones', image: '/headphones.png', price: 3999, originalPrice: 4999 },
  { id: 4, name: 'HP Printer', image: '/printer.png', price: 7499, originalPrice: 8999 },
  { id: 5, name: 'Logitech Mouse', image: '/mouse.png', price: 499, originalPrice: 1099 }
];
...
export default function ProductsPage() {
  ...
  const handleCheckout = () => {
    addOrder(cart); // ✅ just send cart as-is
    clearCart();
    ...
    <>
      {notification && (
        <div className="fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded shadow-lg flex items-center z-50">
          ...
          <Link href="/dashboard/orders" className="ml-4 bg-white text-green-500 px-2 py-1 rounded text-sm hover:bg-green-50">
            View Orders
          </Link>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-lg max-w-md w-full">
            ...
            <div className="flex justify-end space-x-3">
              <button onClick={() => setShowCheckoutModal(false)} className="px-4 py-2 border rounded">Cancel</button>
              <Link href="/dashboard/orders" onClick={handleCheckout} className="px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700">Confirm Order</Link>
            </div>
          </div>
        </div>
      )}
