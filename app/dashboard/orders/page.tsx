    ...
    <>
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-lg p-8 text-center">
          <p className="text-gray-600 mb-4">You havent placed any orders yet</p>
          <Link 
    ...
    <>
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-lg p-8 text-center">
          ...
          <Link href="/dashboard/products" className="inline-block bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700">
            Browse Products
          </Link>
        </div>
      ) : (
